...
This section lists what the app currently does.
...
This section explains the macOS version and development tools needed to build the app.
...
This section provides the shortest path from downloading the source to opening the app.
...
This section is for developers who want to compile and test without installing the app.
...
This section explains which data stays on the Mac and which information is never uploaded.
...
This section helps contributors understand the purpose of each top-level folder and file.
...
This section records important behavior that may surprise someone building from source.
...
This section states how other people may use, modify, and redistribute the source code.
